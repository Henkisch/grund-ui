# WPForms 2.0.3 × Grounded UI text-field contract 0.3.2

Generated by `node reports/run.mjs wpforms`. 7 of 7 published examples contained a text-field; axe reported 0 violation(s) across them. A live docs page can hold several instances; each is checked.
...
| TF-16 The control has no aria-label competing with the label. | recommended | 3 | 3 | root matches :scope:has(:is(.wpforms-field-label, .wpforms-field-sublabel)):has(:is(input:not([type="hidden"], .iti__search-input), textarea)[aria-label]) |
