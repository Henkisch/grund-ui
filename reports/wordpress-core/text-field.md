# WordPress core 7.1.2 × Grounded UI text-field contract 0.3.2

Generated by `node reports/run.mjs wordpress-core`. 7 of 8 published examples contained a text-field; axe reported 0 violation(s) across them. A live docs page can hold several instances; each is checked.
