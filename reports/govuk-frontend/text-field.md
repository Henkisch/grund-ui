# GOV.UK Frontend 6.5.1 × Grounded UI text-field contract 0.3.2

Generated by `node reports/run.mjs govuk-frontend`. 24 of 24 published examples contained a text-field; axe reported 0 violation(s) across them. A live docs page can hold several instances; each is checked.
