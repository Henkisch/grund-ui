# USWDS 3.14.0 × Grounded UI text-field contract 0.3.2

Generated by `node reports/run.mjs uswds`. 5 of 5 published examples contained a text-field; axe reported 0 violation(s) across them. A live docs page can hold several instances; each is checked.
...
| TF-08 The control has a name. | recommended | 2 | 2 | found <input type="text" id="example-input-prefix" class="usa-input"> |
